...
UserDefinedValueType const* TypeProvider::userDefinedValueType(Type const& _actualType, UserDefinedValueTypeDefinition const& _userDefinedValueType)
{
	return createAndGet<UserDefinedValueType>(_actualType, _userDefinedValueType);
}
